...
$thumbDir  = "G:\job\website\assets\featured-clients-thumbs"
...
foreach ($file in $files) {
    ...
    $destPath     = $thumbDir + $relativePath
...
$thumbSize = (Get-ChildItem $thumbDir -Recurse -File | Measure-Object -Property Length -Sum).Sum / 1MB
Write-Host ""
Write-Host "Done! Thumbnails: $([math]::Round($thumbSize,1)) MB"
