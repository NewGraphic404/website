...
# 1. Remove console logs in Scroll Reveal
...
# 3. Disable the infinite marquee loop which duplicates content too much and forces repaint constantly
# It clones it 5 times: or (let i = 0; i < 5; i++) track.innerHTML += original;
# We can reduce it to 1 duplicate
...
# Replace extreme blur with moderate blur to save GPU
...
# Reduce extreme drop-shadows which cause layout thrashing
